...
- `tests/map/edges.test.js` initially failed due to a duplicate `resolveEdgeFile` binding; renamed the aggregate helper to `resolveEdgeFileForAggregate`.
- `node tests/run.js --lane pr` failed with "Unknown lane: pr"; lane not available.
