...
- [x] Task 14.D.3: Add optional external sort for chunk meta if chunk order is non‑deterministic.
- [x] Task 14.D.3.a: Use external merge sort when chunk IDs are out of order.
