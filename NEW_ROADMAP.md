...
4.  Phase 21 — (Conditional) Native LibUV work: only if profiling proves a real gap
5.  Phase 23 — Index analysis features (metadata/risk/git/type-inference) — Review findings & remediation checklist
...
10.  Phase 31 — Isometric Visual Fidelity (Yoink-derived polish)
