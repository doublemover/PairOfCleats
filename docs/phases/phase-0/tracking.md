...
| CI suite runner | In progress | `tools/ci/run-suite.js`, `test:pr`/`test:nightly` | |
...
- Fixture corpus: `docs/phases/phase-0/fixture-corpus.md`
- Baseline determinism test: `tests/perf/baseline-artifacts.test.js`

## Definition of done
- `npm run test:pr` matches CI behavior and is documented.
