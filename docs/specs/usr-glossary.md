...
- USR: Unified Syntax Representation
- Conformance level: C0-C4 capability band
- Hard-block gate: mandatory pass condition
- Advisory gate: non-blocking with remediation requirement
- Evidence artifact: machine-readable output used for gate decisions
- Contract drift: divergence across normative docs and matrices
