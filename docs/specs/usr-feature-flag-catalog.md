...
Defines canonical feature-flag inventory and rollout controls.
...
- ownerTeam
- defaultState
- rolloutClass (experiment, staged, guardrail, migration)
- safeRollbackState
- expiresAt
- affectedContracts[]
...
- all non-temporary flags MUST have sunset plan
- migration flags MUST define cutover and removal criteria
- unknown flag keys MUST fail strict mode

## 3. Baseline flag inventory rows

| flagKey | rolloutClass | defaultState | safeRollbackState |
| --- | --- | --- | --- |
| usr.strictMode | guardrail | true | true |
| usr.frameworkInteropExperimental | experiment | false | false |
| usr.dualWriteArtifacts | migration | false | false |
| usr.qualityGateOverride | staged | false | false |
