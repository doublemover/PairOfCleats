# Spec -- USR Routing Normalization Contract
...
Defines canonical route representation across framework routers.
...
1. Define route declaration parsing for file-based and code-based router models.
2. Define dynamic segment guard middleware and nested layout semantics.
3. Define SSR CSR route boundary and fallback handling diagnostics.
...
- usr-routing-normalization-contract-validation.json
- usr-routing-normalization-contract-drift-report.json
