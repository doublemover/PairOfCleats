# Spec -- USR Framework Macro Transform Contract
...
Defines normalization requirements for macro and compiler transforms.
...
1. Define macro expansion provenance and reversible mapping requirements.
2. Define synthetic node and edge attribution policy for transformed constructs.
3. Define unsupported macro fallback behavior and quality-gate implications.
...
- usr-framework-macro-transform-contract-validation.json
- usr-framework-macro-transform-contract-drift-report.json
