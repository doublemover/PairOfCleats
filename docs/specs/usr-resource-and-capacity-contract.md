# Spec -- USR Resource and Capacity Contract
...
Defines CPU memory IO and storage budgets across lanes and profiles.
...
1. Define budget classes per lane and profile and enforcement in strict vs non-strict modes.
2. Define backpressure circuit breaker and queue shedding policy under saturation.
3. Define mandatory capacity evidence and escalation triggers for repeated overruns.
...
- usr-resource-and-capacity-contract-validation.json
- usr-resource-and-capacity-contract-drift-report.json
