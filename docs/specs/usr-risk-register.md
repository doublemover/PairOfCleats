...
| --- | --- | --- | --- | --- | --- |
| UR-001 | Contract drift across rapidly growing suite | high | automated drift checks + required RFC workflow | usr-architecture | open |
| UR-002 | Evidence freshness failures during cutover windows | high | freshness validator and release checklist hard-block | usr-operations | open |
| UR-003 | Framework interop edge regressions | medium | framework interaction fixtures and quality gates | usr-framework | open |
