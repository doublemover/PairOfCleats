# Spec -- USR Type System Normalization Contract
...
Defines canonical type representation across statically and dynamically typed languages.
...
1. Define normalized type node kinds and relation edges for declarations and usage.
2. Define gradual and unknown type representation and confidence signaling.
3. Define required evidence for type-driven linking in strict modes.
...
- usr-type-system-normalization-contract-validation.json
- usr-type-system-normalization-contract-drift-report.json
