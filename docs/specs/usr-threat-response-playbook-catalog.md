# Spec -- USR Threat Response Playbook Catalog
...
Defines required operational playbooks linked to threat classes.
...
1. Define playbook IDs owners trigger conditions and escalation paths.
2. Define mandatory drills and evidence cadence per threat severity.
3. Define coverage policy mapping threat rows to concrete response playbooks.
...
- usr-threat-response-playbook-catalog-validation.json
- usr-threat-response-playbook-catalog-drift-report.json
