# Spec -- USR Documentation Style Guide
...
- use MUST/SHALL for binding requirements
- avoid ambiguous words in normative sections
- include exact filenames for required artifacts
- define explicit failure behavior for strict mode

## Required sections in contract docs
