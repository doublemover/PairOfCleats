# Spec -- USR Test Data Generation Contract
...
Defines policy for synthetic and harvested fixture generation.
...
1. Define generation strategies realism constraints and anti-overfit controls.
2. Define deterministic seed management and provenance labeling.
3. Define privacy and security controls for generated and harvested fixtures.
...
- usr-test-data-generation-contract-validation.json
- usr-test-data-generation-contract-drift-report.json
