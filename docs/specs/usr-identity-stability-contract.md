# Spec -- USR Identity Stability Contract
...
Defines identity stability guarantees for nodes, symbols, and edges.
...
1. Define stability rules across rename, move, split, and extract-refactor operations.
2. Define allowed identity churn classes and mandatory diagnostic labeling of churn.
3. Define migration adapters for legacy IDs and replay-safe backreferences.
...
- usr-identity-stability-contract-validation.json
- usr-identity-stability-contract-drift-report.json
