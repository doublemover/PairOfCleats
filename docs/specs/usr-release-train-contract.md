# Spec -- USR Release Train Contract
...
Defines release cadence freeze windows and cutover authority model.
...
1. Define train cadence branch policy and stabilization criteria.
2. Define cut no-cut decision gates and rollback authority boundaries.
3. Define hotfix and emergency patch integration rules.
...
- usr-release-train-contract-validation.json
- usr-release-train-contract-drift-report.json
