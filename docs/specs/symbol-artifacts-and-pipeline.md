...
## Tests (required)
### Unit tests
- [contract-matrix.test.js](../../tests/indexing/identity/contract-matrix.test.js)

### Services tests
- [symbol-artifacts-emission.test.js](../../tests/indexing/artifacts/symbols/symbol-artifacts-emission.test.js)
- [symbol-edges-ambiguous.test.js](../../tests/indexing/artifacts/symbols/symbol-edges-ambiguous.test.js)
- [symbol-links-by-chunkuid.test.js](../../tests/indexing/artifacts/symbols/symbol-links-by-chunkuid.test.js)
- [symbol-integrity-strict.test.js](../../tests/indexing/validate/symbol-integrity-strict.test.js)
- [symbol-artifact-order.test.js](../../tests/indexing/determinism/symbol-artifact-order.test.js)
- [symbol-artifact.test.js](../../tests/indexing/determinism/symbol-artifact.test.js)
