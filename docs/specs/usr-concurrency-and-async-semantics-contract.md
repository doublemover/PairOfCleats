# Spec -- USR Concurrency and Async Semantics Contract
...
Defines unified semantics for async and concurrent execution constructs.
...
1. Define normalized async concurrency node kinds and causality edge mapping.
2. Define task scheduling join sync and cancellation semantics.
3. Define interprocedural risk propagation requirements across async boundaries.
...
- usr-concurrency-and-async-semantics-contract-validation.json
- usr-concurrency-and-async-semantics-contract-drift-report.json
