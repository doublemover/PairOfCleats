# Spec -- USR Documentation Lifecycle Policy
...
- deprecations require replacement doc and deprecation reason/date
- archived docs should retain original filename when possible
- active docs must pass drift checks in CI
