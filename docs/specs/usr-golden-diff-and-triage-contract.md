# Spec -- USR Golden Diff and Triage Contract
...
Defines golden output diff policy and triage execution requirements.
...
1. Define diff classes severity and automatic vs manual triage policy.
2. Define ownership SLA and escalation for unresolved blocking diffs.
3. Define deterministic patch acceptance and provenance requirements.
...
- usr-golden-diff-and-triage-contract-validation.json
- usr-golden-diff-and-triage-contract-drift-report.json
