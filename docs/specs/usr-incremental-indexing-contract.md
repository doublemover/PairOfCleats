# Spec -- USR Incremental Indexing Contract
...
Defines correctness constraints for partial rebuilds and cache reuse.
...
1. Define invalidation triggers for source, config, parser, and profile changes.
2. Define stale node and edge eviction and tombstone semantics for deletions and renames.
3. Define parity checks between full and incremental builds with blocking drift thresholds.
...
- usr-incremental-indexing-contract-validation.json
- usr-incremental-indexing-contract-drift-report.json
