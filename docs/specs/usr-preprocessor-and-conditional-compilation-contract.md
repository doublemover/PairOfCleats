# Spec -- USR Preprocessor and Conditional Compilation Contract
...
Defines representation of preprocessor and conditional compilation behavior.
...
1. Define condition evaluation modeling and branch preservation semantics.
2. Define profile-specific active inactive branch handling and diagnostics.
3. Define fallback policy when build context is incomplete.
...
- usr-preprocessor-and-conditional-compilation-contract-validation.json
- usr-preprocessor-and-conditional-compilation-contract-drift-report.json
