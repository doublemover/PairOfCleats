...
Normative language contract for `javascript` under USR.
...
- `astro`, `next`, `nuxt`, `react`, `svelte`, `sveltekit`, `vue`

## Required node kinds

- `call_expr`, `class_decl`, `export_stmt`, `function_decl`, `import_stmt`, `module_decl`

## Required edge kinds

- `calls`, `defines`, `exports`, `imports`, `references`, `uses_type`
...
- `javascript::baseline::coverage-001`
- `javascript::normalization::jsx-element-001`
