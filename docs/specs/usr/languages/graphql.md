...
Normative language contract for `graphql` under USR.
...
- `graphql_type_decl`, `interface_decl`, `sql_stmt`, `type_alias_decl`

## Required edge kinds

- `contains`, `references`, `uses_type`
