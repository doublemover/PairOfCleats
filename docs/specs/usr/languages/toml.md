...
Normative language contract for `toml` under USR.
...
- `config_key`, `config_mapping`, `config_scalar`, `config_section`
...
- `toml::baseline::coverage-001`
- `toml::config::array-of-tables-001`
