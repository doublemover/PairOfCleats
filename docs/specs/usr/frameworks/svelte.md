...
Normative framework contract for `svelte` under USR.
...
- `requiredEdgeKinds`: `hydration_boundary`, `style_scopes`, `template_binds`, `template_emits`
...
- `blockingFixtureIds`: `svelte::framework-overlay::baseline-001`
