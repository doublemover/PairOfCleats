...
Prefer `pairofcleats search`, `pairofcleats index build`, `pairofcleats index watch`, and `pairofcleats workspace <manifest|status|build>` for user-facing workflows.
