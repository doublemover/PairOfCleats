...
Prefer `pairofcleats search`, `pairofcleats index build`, `pairofcleats index watch`, and `pairofcleats ingest <ctags|gtags|lsif|scip>` for user-facing workflows.
TUI workflows: `pairofcleats tui supervisor`, `pairofcleats tui build`, `pairofcleats tui install`, and `pairofcleats-tui`.
