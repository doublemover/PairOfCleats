...
Generated: 2026-01-06T06:35:46.494Z
...
- PAIROFCLEATS_TEST_LOG_DIR (1 files)
...
- PAIROFCLEATS_WORKER_POOL (2 files)
...
alias, ann, async, awaits, backend, bm25-b, bm25-k1, branch, branches, breaks, calls, case, case-file, case-tokens, chunk-author, churn, continues, decorator, explain, ext, extends, file, fts-profile, fts-weights, generator, headline, human, inferred-type, json, json-compact, lang, lint, loops, matched, meta, meta-json, mode, model, modified-after, modified-since, mutates, param, path, profile, reads, repo, return-type, returns, risk, risk-category, risk-flow, risk-sink, risk-source, risk-tag, signature, stats, struct-pack, struct-rule, struct-tag, throws, uses, visibility, why, writes
...
ann, enforce, limit, out, queries, search, sqlite-backend, top, write-report
...
dict, dp-max, json, out, sample, tokens
...
batch, dims, mode, repo, stub-embeddings

### tools/build-sqlite-index.js

code-dir, compact, incremental, mode, out, prose-dir, repo, validate
...
dir, force, lang, repo, update, url

### tools/download-extensions.js

arch, dir, force, out, platform, provider, repo, update, url
