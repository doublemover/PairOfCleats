...
- Claim: explain output includes score breakdowns and backend policy hints.
  ...
  - Tests: `tests/search-explain-symbol.js`, `tests/search-rrf.js`, `tests/retrieval/contracts/result-shape.test.js`, `tests/retrieval/filters/query-syntax/phrases-and-scorebreakdown.test.js`.
