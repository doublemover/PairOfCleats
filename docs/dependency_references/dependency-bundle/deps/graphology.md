...
- [x] Add at least one representative test fixture and a regression benchmark. (Planned fixture: graph fixture corpus coverage. Planned benchmark: `tests/indexing/type-inference/crossfile/output.integration.test.js`.)
