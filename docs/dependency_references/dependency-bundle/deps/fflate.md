...
- [x] Add at least one representative test fixture and a regression benchmark. (Planned fixture: tests/indexing/artifacts/artifact-formats.test.js (compressed artifact variants). Planned benchmark: tools/index/report-artifacts.js throughput.)