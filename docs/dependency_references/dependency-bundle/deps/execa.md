...
1. API reference (stdio, all, reject, cleanup, pipes)  https://github.com/sindresorhus/execa
...
- [x] Add at least one representative test fixture and a regression benchmark. (Fixture: `tests/tooling/triage/ingest-decision-contract-matrix.test.js` and related triage ingest coverage. Benchmark: tools/bench/language-repos.js.)
