...
- [x] Add at least one representative test fixture and a regression benchmark. (Planned fixture: tools/index/shard-census.js sample outputs. Planned benchmark: tools/index/shard-census.js or shared runtime concurrency coverage.)
