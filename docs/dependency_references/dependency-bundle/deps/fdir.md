...
- [x] Add at least one representative test fixture and a regression benchmark. (Fixture: `tests/indexing/discovery/contract-matrix.test.js` (discovery pipeline). Benchmark: tools/bench/language-repos.js.)
