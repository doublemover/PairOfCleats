...
- [x] Add at least one representative test fixture and a regression benchmark. (Planned fixture: `tests/retrieval/filters/search-filter-contract-matrix.test.js` or related risk-filter coverage. Planned benchmark: tests/perf/bench/run.test.js.)
