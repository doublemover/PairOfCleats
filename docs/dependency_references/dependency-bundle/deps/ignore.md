...
- [x] Add at least one representative test fixture and a regression benchmark. (Fixture: planned ignore-override and watch-filter coverage under the indexing ignore/watch families. Benchmark: tools/bench/language-repos.js.)
