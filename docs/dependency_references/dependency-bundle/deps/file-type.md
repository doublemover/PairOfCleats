...
- [x] Add at least one representative test fixture and a regression benchmark. (Planned fixture: binary sample corpus coverage. Planned benchmark: `tests/indexing/discovery/contract-matrix.test.js` or tools/bench/language-repos.js.)
