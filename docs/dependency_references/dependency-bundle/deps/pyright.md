...
- [x] Add at least one representative test fixture and a regression benchmark. (Planned fixture: `tests/indexing/type-inference/crossfile/output.integration.test.js` (python). Planned benchmark: tools/bench/language-repos.js.)
