...
- docs: `docs/commands.md` and any profile gating notes
...
- `tools/validate-config.js` → validate minimal config only
...
- Large portions of `docs/env-overrides.md` (rewrite)
- `tools/generate-demo-config.js` (likely delete)
