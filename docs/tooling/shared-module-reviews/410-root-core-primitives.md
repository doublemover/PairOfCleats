...
- The extracted helpers under [`src/shared/auto-policy/`](C:/Users/sneak/Development/DOUBLECLEAT/src/shared/auto-policy) are the right seam for repo scanning and profile selection logic.
