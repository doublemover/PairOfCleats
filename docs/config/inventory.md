...
Generated: 2026-02-06T08:01:31.856Z
...
- PAIROFCLEATS_TEST_GRAPH_PLATEAU_CHILD (1 files)
...
- PAIROFCLEATS_TESTING (106 files)
...
additionalProperties, all, allow-unauthenticated, allowed-repo-roots, ann, ann-mode, ann-modes, arch, args, artifactDir, auth-token, avg, avgBytes, backends, backup, baseline, batch, bench, bits, build, build-index, build-sqlite, cache-dir, cache-root, caps, cert-dir, changed, changedFile, chunk, chunk-meta-size, clean, code, collapse, colorize, column, command, concurrency, config, cors-allow-any, cors-allowed-origins, count, ctags, dataset, depth, destination, dict, dims, dir, direction, display-edges, display-files, display-members, docBytes, docs, dp-max, draw-edges, draw-files, draw-labels, draw-members, dry-run, edgeTypes, edits, emitArtifact, encoding, enforce, enforce-fts, engine, evidence, expires, extensions, fail-fast, failOnViolation, failOnWarn, fanout, fields, files, filesPerLanguage, finding, fixture, fixtures, flowMode, focus, force, format, frame-budget, from, global, graphFixture, graphs, hashes, hops, in, include, include-prose, includeCallersCallees, includeCalls, includeGraph, includeImports, includePaths, includeRisk, includeTypes, includeUsages, incremental, index, index-root, input, inputs, interactive, interval, iterations, justification, keep, keep-backup, keys, lang, languages, limit, list-packs, load, lod-edge-high, lod-edge-low, lod-zoom-high, lod-zoom-low, log, log-dir, lookups, maskBits, match-mode, max, max-age-days, max-body-bytes, max-bytes, max-delta, max-edges, max-files, max-gb, max-members-per-file, maxBytes, maxCalls, maxCallsPerSymbol, maxCandidates, maxDepth, maxEdgeBytes, maxEdges, maxEdgesExamined, maxFanoutPerNode, maxNodes, maxPaths, maxPerHit, maxSymbols, maxTokens, maxTotal, maxTypeEntries, maxViolations, maxWallClockMs, maxWarnings, maxWorkUnits, mcp-mode, mergeProb, meta, min, min-count, min-overlap, min-overlap-single, min-rank-corr, minBytes, minConfidence, missingDocHashRate, model, model-out, models, module, no-ann, no-fallback, node-list-out, nodes, non-interactive, non-strict, only-exported, onlyExported, onlyExports, onnx, onnx-path, open, open-uri-template, options, out, out-dir, outDir, output, pack, path, perf, platform, pretty, progress, properties, provider, queries, queries-dir, queue, quiet, reason, record, refresh, registry, repeats, require-dicts, require-index, require-sqlite, required, results, retries, reviewer, root, rows, rule, rules, run, runSize, runs, sample, samples, schema, scheme, scip, scope, search, seed, segmentBytes, segments, sha256, sink-rule, size, skip-artifacts, skip-bench, skip-build, skip-dicts, skip-extensions, skip-index, skip-install, skip-models, skip-script-coverage, skip-sqlite, skip-tooling, skip-validate, sort, source, source-rule, sqlite-backend, stage, status, strict, stub-embeddings, table, targets, testPattern, thrashMaxLoadedLanguages, three-url, timeout-ms, token-postings-size, tokenSize, tokens, tooling-scope, tools, top-k-by-degree, translateTime, treeSitter, treeSitterMissingLanguages, type, unique, update, url, useQueries, validate, validate-config, verbose, warmMaxLoadedLanguages, wasd-acceleration, wasd-drag, wasd-max-speed, wasd-sensitivity, windowBytes, with-sqlite, write-report, yes, zoom-sensitivity
...
### tests/tooling/script-coverage/script-coverage.test.js
...
filesPerLanguage, json, languages, log, out, repeats, thrashMaxLoadedLanguages, treeSitter, useQueries, warmMaxLoadedLanguages
