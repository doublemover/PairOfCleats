...
Generated: 2026-02-03T14:28:13.924Z
...
additionalProperties, all, allow-unauthenticated, allowed-repo-roots, ann, ann-mode, ann-modes, arch, args, artifactDir, auth-token, backends, backup, baseline, batch, bench, build, build-index, build-sqlite, cache-dir, cache-root, caps, cert-dir, changed, changedFile, chunk, chunk-meta-size, clean, code, code-dir, collapse, colorize, column, command, compact, concurrency, config, cors-allow-any, cors-allowed-origins, count, ctags, dataset, depth, destination, dict, dims, dir, direction, dp-max, dry-run, edgeTypes, emitArtifact, encoding, enforce, enforce-fts, engine, evidence, expires, extensions, extracted-prose-dir, fail-fast, failOnViolation, failOnWarn, fields, finding, fixture, fixtures, flowMode, focus, force, format, from, global, graphFixture, graphs, hops, in, include, include-prose, includeCallersCallees, includeCalls, includeGraph, includeImports, includePaths, includeRisk, includeTypes, includeUsages, incremental, index, index-root, input, inputs, interactive, interval, justification, keep-backup, lang, languages, limit, list-packs, load, log, log-dir, match-mode, max, max-age-days, max-body-bytes, max-bytes, max-delta, max-edges, max-files, max-gb, max-members-per-file, maxBytes, maxCalls, maxCallsPerSymbol, maxCandidates, maxDepth, maxEdges, maxEdgesExamined, maxFanoutPerNode, maxNodes, maxPaths, maxPerHit, maxSymbols, maxTokens, maxTotal, maxTypeEntries, maxViolations, maxWallClockMs, maxWarnings, maxWorkUnits, mcp-mode, meta, min-count, min-overlap, min-overlap-single, min-rank-corr, minConfidence, model, model-out, models, module, no-ann, no-compact, no-fallback, node-list-out, non-interactive, non-strict, only-exported, onlyExported, onlyExports, onnx, onnx-path, open, open-uri-template, options, out, out-dir, outDir, output, pack, path, perf, platform, pretty, progress, properties, prose-dir, provider, queries, queries-dir, queue, quiet, reason, record, records-dir, refresh, registry, require-dicts, require-index, require-sqlite, required, results, retries, reviewer, root, rule, rules, run, sample, schema, scip, scope, search, seed, sha256, sink-rule, skip-artifacts, skip-bench, skip-build, skip-dicts, skip-extensions, skip-index, skip-install, skip-models, skip-script-coverage, skip-sqlite, skip-tooling, skip-validate, sort, source, source-rule, sqlite-backend, stage, status, strict, stub-embeddings, table, testPattern, three-url, timeout-ms, token-postings-size, tokens, tooling-scope, tools, top-k-by-degree, topKByDegree, translateTime, treeSitter, type, update, url, validate, validate-config, verbose, wasd-acceleration, wasd-drag, wasd-max-speed, wasd-sensitivity, with-sqlite, write-report, yes, zoom-sensitivity
