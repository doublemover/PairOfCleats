...
Generated: 2026-02-22T23:55:35.989Z
...
- PAIROFCLEATS_BENCH_RUN (7 files)
...
- PAIROFCLEATS_TEST_STUB_PDF_EXTRACT (11 files)
...
- PAIROFCLEATS_WORKER_POOL (42 files)
...
ann, backend, baseline, build, build-sqlite, cache-root, checkpoint, dataset, embedding-sample-files, embedding-sample-seed, heap-mb, incremental, json, limit, mode, models, no-ann, out, queries, repo, resume, skip-compare, skip-eval, stub-embeddings, top
