...
Generated: 2026-02-22T09:09:43.102Z
...
additionalProperties, all, ann, ann-mode, ann-modes, apply, arch, args, artifactDir, as-of, astDataflowEnabled, avg, avgBytes, backends, backup, baseline, batch, bench, bits, build, build-index, build-sqlite, cache-dir, cache-root, caps, cert-dir, changed, changedFile, chunk, chunk-meta-size, clean, code, collapse, colorize, column, controlFlowEnabled, count, ctags, dataset, depth, destination, detectRenames, dict, dims, dir, direction, display-edges, display-files, display-members, docBytes, docs, dp-max, draw-edges, draw-files, draw-labels, draw-members, dry-run, edgeTypes, edits, emitArtifact, encoding, enforce, enforce-fts, engine, event-log-dir, evidence, expires, ext, extensions, fail-fast, failOnViolation, failOnWarn, fanout, fields, fileSizeBytes, files, filesPerLanguage, finding, fixture, fixtures, flowMode, focus, force, forcePrepare, format, frame-budget, from, global, grace-days, graphFixture, graphs, groups, hashes, hops, in, include, include-prose, includeCallersCallees, includeCalls, includeGraph, includeImports, includePaths, includeRelations, includeRisk, includeTypes, includeUsages, incremental, index, index-dir, index-root, input, inputs, install-root, interactive, iterations, justification, keep, keep-backup, keys, lang, languages, limit, list-groups, list-packs, load, lod-edge-high, lod-edge-low, lod-zoom-high, lod-zoom-low, log, log-dir, lookups, maskBits, match-mode, max, max-age-days, max-bytes, max-deletes, max-delta, max-edges, max-files, max-gb, max-members-per-file, maxBytes, maxCalls, maxCallsPerSymbol, maxCandidates, maxChangedFiles, maxChunksPerFile, maxDepth, maxEdgeBytes, maxEdges, maxEdgesExamined, maxFanoutPerNode, maxNodeBytes, maxNodes, maxPaths, maxPerHit, maxSymbols, maxTokens, maxTotal, maxTypeEntries, maxViolations, maxWallClockMs, maxWarnings, maxWorkUnits, mcp-mode, mergeProb, meta, min, min-count, min-overlap, min-overlap-single, min-rank-corr, minBytes, minConfidence, missingDocHashRate, model, model-out, models, module, no-ann, no-fallback, node-list-out, nodes, non-interactive, non-strict, only-exported, onlyExported, onlyExports, onnx, onnx-path, open, open-uri-template, options, out, out-dir, outDir, pack, path, perf, platform, pretty, progress, properties, provider, pythonAst, queries, queries-dir, record, refresh, registry, repeats, require-dicts, require-index, require-sqlite, required, results, retries, reviewer, root, rows, rule, rules, run, runSize, runs, sample, samples, schema, scheme, scip, scope, search, seed, segmentBytes, segments, sha256, shard-count, shard-index, sink-rule, size, skip-artifacts, skip-bench, skip-build, skip-dicts, skip-extensions, skip-index, skip-install, skip-models, skip-script-coverage, skip-sqlite, skip-tooling, skip-validate, skipPrepare, snapshot, sort, source, source-rule, sqlite-backend, status, strict, stub-embeddings, table, target, targets, testPattern, three-url, timeout-ms, token-postings-size, tokenSize, tokens, tooling-scope, tools, top-k-by-degree, translateTime, treeSitter, treeSitterMissingLanguages, type, unique, update, url, useQueries, validate, validate-config, verbose, verify, wasd-acceleration, wasd-drag, wasd-max-speed, wasd-sensitivity, windowBytes, with-sqlite, workspace, write-report, yes, zoom-sensitivity
