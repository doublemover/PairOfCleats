...
- SQLite backends require sqlite artifacts per model cache. Use `--build-sqlite` when those artifacts are missing; otherwise prebuilt sqlite artifacts are reused.
