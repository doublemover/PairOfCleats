...
Open audit items:
- Scan remaining features for one-off normalization or truncation helpers.
- Verify benchmarking, ANN, embedding, and test runner utilities share common helpers where possible.
