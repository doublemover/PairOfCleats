...
- [x] **Add `tests/identity/symbol-identity.test.js`**
...
- [x] **Add `tests/crossfile/resolve-relative-import.test.js`**
  - table-driven tests for extension probing and index resolution.

- [x] **Add `tests/crossfile/symbolref-resolution.test.js`**
...
- [x] Add `tests/artifacts/symbol-artifacts-smoke.test.js`
...
- [x] Update `tests/graph-chunk-id.js`
  - Ensure:
...
- [x] Add `tests/map/map-build-symbol-identity.test.js`
...
- [x] `tests/determinism/symbol-artifact-order.test.js`
...
Add:
- [x] `tests/risk-interprocedural/config-normalization.test.js`
  - [x] unit test `normalizeRiskInterproceduralConfig`
  - [x] include edge cases: alias values, bad types, clamp behavior
- [x] `tests/risk-interprocedural/runtime-gating.test.js`
...
Add:
- [x] `tests/lang/javascript-paramnames.test.js`
...
Add:
- [x] `tests/risk-interprocedural/callsite-id.test.js`
  - [x] Ensure the shared helper matches the writer's output on representative inputs.
- [x] `tests/risk-interprocedural/callsite-sampling.test.js`
...
- [x] `tests/risk-interprocedural/flows-conservative.test.js`
...
- [x] `tests/risk-interprocedural/flows-argaware-negative.test.js`
  - [x] modify fixture so tainted value is NOT passed (e.g., `build("constant")`)
  - [x] argAware should emit 0 flows
- [x] `tests/risk-interprocedural/flows-sanitizer-policy.test.js`
...
- [x] `tests/risk-interprocedural/flows-timeout.test.js`
...
Add:
- [x] `tests/risk-interprocedural/artifacts-written.test.js`
...
Add:
- [x] `tests/validator/risk-interprocedural.test.js`
...
Add:
- [x] `tests/cli/risk-explain.test.js`
...
- [x] Determinism:
  - [x] output stable across runs given same codebase and config (use `tests/risk-interprocedural/summaries-determinism.test.js` and a flow determinism test).
