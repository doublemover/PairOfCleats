...
- `docs/contracts/artifact-schemas.md` (~L1-L108)
- `docs/contracts/indexing.md` (~L1-L90)
- `docs/guides/commands.md` (~L1-L165)
- `docs/guides/editor-integration.md` (~L1-L47)
- `docs/guides/release-discipline.md` (~L1-L25)
- `docs/guides/release-matrix.md` (new)
- `docs/guides/service-mode.md` (~L1-L73)
- `docs/perf/native-accel.md` (new)
- `docs/specs/document-extraction.md` (new)
- `docs/specs/native-accel.md` (new)
- `docs/specs/prose-routing.md` (new)
- `docs/specs/vector-only-profile.md` (new)
- `docs/testing/truth-table.md` (~L1-L168)
- `extensions/vscode/**` (new)
- `extensions/vscode/.vscodeignore` (new)
- `extensions/vscode/extension.js` (~L1-L176)
- `extensions/vscode/package.json` (~L1-L80)
- `pdfjs-dist/build/pdf.js` (new)
- `pdfjs-dist/legacy/build/pdf.js|pdf.mjs` (new)
- `src/contracts/schemas/artifacts.js` (~L1-L1246)
- `src/contracts/schemas/build-state.js` (~L1-L208)
- `src/contracts/validators/artifacts.js` (~L1-L36)
- `src/contracts/validators/build-state.js` (~L1-L33)
- `src/index/build/artifacts.js` (~L1-L659)
- `src/index/build/build-state.js` (~L1-L738)
- `src/index/build/discover.js` (~L1-L371)
- `src/index/build/file-processor.js` (~L1-L551)
- `src/index/build/file-processor/assemble.js` (~L1-L154)
- `src/index/build/file-processor/embeddings.js` (~L1-L269)
- `src/index/build/file-processor/skip.js` (~L1-L82)
- `src/index/build/indexer/pipeline.js` (~L1-L486)
- `src/index/build/indexer/signatures.js` (~L1-L150)
- `src/index/build/indexer/steps/postings.js` (~L1-L207)
- `src/index/build/indexer/steps/write.js` (~L1-L192)
- `src/index/build/runtime/runtime.js` (~L1-L893)
- `src/index/chunking/dispatch.js` (~L1-L625)
- `src/index/chunking/formats/docx.js` (new)
- `src/index/chunking/formats/pdf.js` (new)
- `src/index/chunking/limits.js` (~L1-L128)
- `src/index/extractors/docx.js` (new)
- `src/index/extractors/pdf.js` (new)
- `src/index/metadata-v2.js` (~L1-L304)
- `src/index/validate/index-validate.js` (new)
- `src/retrieval/ann/providers/*` (new)
- `src/retrieval/bitmap.js` (~L1-L214)
- `src/retrieval/cli/index-state.js` (~L1-L25)
- `src/retrieval/filter-index.js` (~L1-L195)
- `src/retrieval/filters.js` (~L1-L294)
- `src/retrieval/index-load.js` (new)
...
- `src/retrieval/pipeline/ann-backends.js` (~L1-L49)
- `src/retrieval/pipeline/candidates.js` (~L1-L124)
- `src/retrieval/pipeline/fusion.js` (~L1-L134)
- `src/retrieval/pipeline/graph-ranking.js` (~L1-L155)
- `src/retrieval/providers/*` (new)
- `src/retrieval/query-intent.js` (~L1-L85)
- `src/retrieval/query-parse.js` (~L1-L10)
- `src/retrieval/query.js` (~L1-L362)
- `src/retrieval/rankers.js` (~L1-L324)
- `src/retrieval/sqlite-cache.js` (~L1-L91)
- `src/retrieval/sqlite-helpers.js` (~L1-L574)
- `src/shared/capabilities.js` (~L1-L49)
- `src/shared/files.js` (~L1-L64)
- `src/shared/native-accel.js` (new)
- `src/shared/optional-deps.js` (~L1-L54)
- `src/shared/subprocess.js` (~L1-L437)
- `src/shared/worker-pool.js` (new)
- `sublime/PairOfCleats/` (new)
- `sublime/PairOfCleats/**` (new)
- `sublime/PairOfCleats/README.md` (~L1-L112)
- `tests/helpers/python.js` (new)
- `tests/helpers/skip.js` (~L1-L13)
- `tests/helpers/test-env.js` (~L1-L109)
- `tests/indexing/chunking/docx-chunking-deterministic.test.js` (new)
- `tests/indexing/chunking/pdf-chunking-deterministic.test.js` (new)
- `tests/indexing/contracts/profile-artifacts-present-omitted-consistency.test.js` (new)
- `tests/indexing/contracts/profile-index-state-contract.test.js` (new)
- `tests/indexing/contracts/profile-index-state-has-required-artifacts.test.js` (new)
- `tests/indexing/extracted-prose/document-bytes-hash-stable.test.js` (new)
- `tests/indexing/extracted-prose/document-chunk-id-no-collision.test.js` (new)
- `tests/indexing/extracted-prose/document-extraction-checksums-and-counts.test.js` (new)
- `tests/indexing/extracted-prose/document-extraction-outcomes-recorded.test.js` (new)
- `tests/indexing/extracted-prose/document-extractor-version-recorded.test.js` (new)
- `tests/indexing/extracted-prose/documents-included-when-available.test.js` (new)
- `tests/indexing/extracted-prose/documents-skipped-when-unavailable.test.js` (new)
- `tests/indexing/extracted-prose/docx-missing-dep-skips.test.js` (new)
- `tests/indexing/extracted-prose/docx-smoke.test.js` (new)
- `tests/indexing/extracted-prose/extraction-report.test.js` (new)
- `tests/indexing/extracted-prose/pdf-missing-dep-skips.test.js` (new)
- `tests/indexing/extracted-prose/pdf-smoke.test.js` (new)
- `tests/indexing/metav2/metaV2-extracted-doc.test.js` (new)
- `tests/indexing/metav2/metaV2-unknown-fields-ignored.test.js` (new)
- `tests/indexing/postings/vector-only-does-not-emit-sparse.test.js` (new)
- `tests/indexing/postings/vector-only-missing-embeddings-is-error.test.js` (new)
- `tests/indexing/postings/vector-only-switching-cleans-stale-sparse.test.js` (new)
- `tests/indexing/validate/vector-only-artifact-contract.test.js` (new)
- `tests/perf/chunking/chunking-limits-large-input.test.js` (new)
- `tests/retrieval/backend/fts-missing-table-fallback.test.js` (new)
- `tests/retrieval/backend/fts-tokenizer-config.test.js` (new)
- `tests/retrieval/backend/rankSqliteFts-allowedIds-correctness.test.js` (new)
- `tests/retrieval/backend/rankSqliteFts-missing-table-is-controlled-error.test.js` (new)
- `tests/retrieval/backend/rankSqliteFts-weight-before-limit.test.js` (new)
- `tests/retrieval/backend/search-routing-policy.test.js` (new)
- `tests/retrieval/backend/sqlite-missing-sparse-tables-is-controlled-error.test.js` (new)
- `tests/retrieval/backend/unpackUint32-buffer-alignment.test.js` (new)
- `tests/retrieval/backend/vector-only-compatibility-key-mismatch.test.js` (new)
- `tests/retrieval/backend/vector-only-rejects-sparse-mode.test.js` (new)
- `tests/retrieval/backend/vector-only-search-requires-ann.test.js` (new)
- `tests/retrieval/contracts/score-breakdown-budget-limits.test.js` (new)
- `tests/retrieval/contracts/score-breakdown-contract-parity.test.js` (new)
- `tests/retrieval/contracts/score-breakdown-snapshots.test.js` (new)
...
- `tests/retrieval/native/perf-baseline.test.js` (new)
...
- `tests/retrieval/output/explain-output-includes-routing-and-fts-match.test.js` (new)
- `tests/retrieval/output/explain-vector-only-warnings.test.js` (new)
- `tests/retrieval/query/boolean-inventory-vs-semantics.test.js` (new)
- `tests/retrieval/query/boolean-unary-not-whitespace.test.js` (new)
- `tests/retrieval/query/query-intent-path-heuristics.test.js` (new)
- `tests/retrieval/query/sqlite-fts-query-escape.test.js` (new)
- `tests/run.js` (~L1-L487)
- `tests/services/service-mode-smoke.test.js` (new)
- `tests/services/sqlite-hydration-metaV2-parity.test.js` (new)
- `tests/tooling/platform/path-edge-cases.test.js` (new)
- `tests/tooling/platform/paths-with-spaces.test.js` (new)
- `tests/tooling/platform/windows-paths-smoke.test.js` (new)
- `tests/tooling/python/python-availability-skip.test.js` (new)
- `tests/tooling/python/python-skip-message.test.js` (new)
- `tests/tooling/release/release-check-exit-codes.test.js` (new)
- `tests/tooling/release/release-check-json.test.js` (new)
- `tests/tooling/release/release-check-smoke.test.js` (new)
- `tests/tooling/script-coverage/*` (new)
- `tests/tooling/script-coverage/actions.test.js` (new)
- `tests/tooling/script-coverage/harness-parity.test.js` (new)
- `tests/tooling/script-coverage/report.test.js` (new)
- `tests/tooling/sublime/package-determinism.test.js` (new)
- `tests/tooling/sublime/package-structure.test.js` (new)
- `tests/tooling/sublime/sublime-pycompile.test.js` (~L1-L49)
- `tests/tooling/sublime/test_*.py` (new)
- `tests/tooling/vscode/extension-packaging.test.js` (new)
- `tests/tooling/vscode/vscode-extension.test.js` (~L1-L50)
...
- `tools/release/check.js` (~L1-L64)
- `tools/service/**` (new)
- `tools/service/indexer-service.js` (~L1-L486)
