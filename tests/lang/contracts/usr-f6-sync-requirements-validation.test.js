...
assertTestInCiOrders('lang/contracts/usr-harness-exit-lock-validation', 'F.6.4');
assertTestInCiOrders('lang/contracts/usr-rollout-f1-checklist-validation', 'F.6.4');
assertTestInCiOrders('lang/contracts/usr-rollout-evidence-lock-validation', 'F.6.4');
assertTestInCiOrders('lang/contracts/usr-gonogo-decision-lock-validation', 'F.6.4');
assertTestInCiOrders('lang/contracts/usr-conformance-exit-lock-validation', 'F.6.4');
assertTestInCiOrders('lang/contracts/usr-readiness-authorization-lock-validation', 'F.6.4');
assertTestInCiOrders('lang/contracts/usr-readiness-audit-lock-validation', 'F.6.4');
...
assertTestInCiOrders('lang/contracts/usr-integration-failure-exit-lock-validation', 'F.6.5');
assertTestInCiOrders('lang/contracts/usr-ci-gate-lock-validation', 'F.6.5');
assertTestInCiOrders('lang/contracts/usr-reporting-lock-validation', 'F.6.5');
assertTestInCiOrders('lang/contracts/usr-maintenance-lock-validation', 'F.6.5');
assertTestInCiOrders('lang/contracts/usr-rollout-exit-lock-validation', 'F.6.5');
assertTestInCiOrders('lang/contracts/usr-semantics-exit-lock-validation', 'F.6.5');
assertTestInCiOrders('lang/contracts/usr-fixture-golden-exit-lock-validation', 'F.6.5');
assertTestInCiOrders('lang/contracts/usr-hardening-readiness-validation', 'F.6.5');
assertTestInCiOrders('lang/contracts/usr-hardening-exit-lock-validation', 'F.6.5');
