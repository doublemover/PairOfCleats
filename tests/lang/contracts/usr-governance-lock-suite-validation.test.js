...
const lockRows = [
  ...
  { anchor: '### N.10 Phase 9 readiness authorization lock', testId: 'lang/contracts/usr-readiness-authorization-lock-validation' },
  { anchor: '### N.11 Gate B1-B7 language-batch completion lock', testId: 'lang/contracts/usr-gate-b-language-batch-lock-validation' },
  { anchor: '### N.12 Phase 9.1 readiness-audit completion lock', testId: 'lang/contracts/usr-readiness-audit-lock-validation' },
  { anchor: '### N.13 Gate C conformance-authorization chain lock', testId: 'lang/contracts/usr-gate-c-authorization-chain-validation' },
  { anchor: '### N.14 Appendix F.1 phase-evidence lock', testId: 'lang/contracts/usr-rollout-evidence-lock-validation' },
  { anchor: '### N.15 Phase 9.2 go/no-go decision lock', testId: 'lang/contracts/usr-gonogo-decision-lock-validation' },
  { anchor: '### N.16 Gate C evidence-completeness lock', testId: 'lang/contracts/usr-gate-c-evidence-completeness-lock-validation' },
  { anchor: '### N.17 Phase 15 exit-completion lock', testId: 'lang/contracts/usr-rollout-exit-lock-validation' },
  { anchor: '### N.18 Phase 15.2 reporting-integrity lock', testId: 'lang/contracts/usr-reporting-lock-validation' },
  { anchor: '### N.19 Phase 15.1 CI gate-integrity lock', testId: 'lang/contracts/usr-ci-gate-lock-validation' },
  { anchor: '### N.20 Phase 15.3 maintenance-integrity lock', testId: 'lang/contracts/usr-maintenance-lock-validation' },
  { anchor: '### N.21 Phase 14.3 integration/failure exit lock', testId: 'lang/contracts/usr-integration-failure-exit-lock-validation' },
  { anchor: '### N.22 Phase 11-13 conformance exit-integrity lock', testId: 'lang/contracts/usr-conformance-exit-lock-validation' },
  { anchor: '### N.23 Phase 10.3 harness exit-integrity lock', testId: 'lang/contracts/usr-harness-exit-lock-validation' },
  { anchor: '### N.24 Phase 8.4 hardening exit-integrity lock', testId: 'lang/contracts/usr-hardening-exit-lock-validation' },
  { anchor: '### N.25 Phase 7.3 fixture/golden exit-integrity lock', testId: 'lang/contracts/usr-fixture-golden-exit-lock-validation' },
  { anchor: '### N.26 Phase 6.6 semantics exit-integrity lock', testId: 'lang/contracts/usr-semantics-exit-lock-validation' }
];
