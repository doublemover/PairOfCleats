...
assert.equal(annCandidateSets.length, 2, 'expected ANN fallback retry for filtered too-large policy');
assert.deepEqual(
  annCandidateSets[0],
  [0, 1],
...
console.log('ann fallback filtered-too-large test passed');
