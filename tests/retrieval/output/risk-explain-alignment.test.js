...
assert.equal(standalone.markdown, fromPack.markdown, 'expected standalone and context-pack explanation rendering to align');
assert.deepEqual(standalone.json.flows, fromPack.json.flows, 'expected standalone and context-pack explanation flow JSON to align');
