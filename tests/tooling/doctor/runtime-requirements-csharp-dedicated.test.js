...
assert.ok(dotnetRuntimeCheck, 'expected .NET SDK requirement check');
assert.equal(dotnetRuntimeCheck.status, 'error', 'expected .NET SDK check error when dotnet command missing');
