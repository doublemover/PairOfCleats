...
const helper = path.join(root, 'tests', 'helpers', 'sublime', 'index_behavior.py');
...
assert.equal(result.status, 0, 'sublime index behavior helper failed');
console.log('sublime index behavior test passed');
