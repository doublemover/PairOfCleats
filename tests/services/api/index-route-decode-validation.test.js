...
const { handled: diffHandled, response: diffResponse } = await invokeRouteWithMockResponse(handleIndexDiffsRoute, {
...
const { handled: snapshotHandled, response: snapshotResponse } = await invokeRouteWithMockResponse(handleIndexSnapshotsRoute, {
