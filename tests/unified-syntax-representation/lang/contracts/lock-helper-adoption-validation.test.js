...
const bannedHelperDefinitions = [
  {
    ...
    message: 'local extractSection helper must not be redefined; use lock-test-utils.js'
  },
  {
    token: 'const extractHeadingSection =',
    message: 'local extractHeadingSection helper must not be redefined; use lock-test-utils.js'
  },
  {
    token: 'const checklistLineState =',
    message: 'local checklistLineState helper must not be redefined; use lock-test-utils.js'
  },
  {
    token: 'const hasUnchecked =',
    message: 'local hasUnchecked helper must not be redefined; use lock-test-utils.js'
  },
  {
    token: 'const assertTestsPresent =',
    message: 'local assertTestsPresent helper must not be redefined; use lock-test-utils.js'
  }
];
