...
const tempRoot = await fs.mkdtemp(path.join(os.tmpdir(), 'pairofcleats-workspace-buildid-absolute-'));
...
console.log('workspace absolute buildId pointer invalid test passed');
