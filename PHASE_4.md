...
## Currently Failing Tests:
  Failures:
     - [ 850ms] abort/abort-propagates-to-queues.test (exit 13)
     - [  88ms] async/runwithqueue-failfast.test (exit 1)
     - [ 240ms] cli (exit 1)
     - [ 10.7s] code-map-dot (exit 1)
     - [ 145ms] concurrency-run-with-queue-abort (exit 13)
     - [  80ms] concurrency-run-with-queue-best-effort (exit 1)
     - [ 13.9s] e2e-smoke (exit 1)
     - [ 17.7s] hnsw-atomic (exit 1)
     - [ 2.96s] index-config-dump (exit 1)
     - [ 174ms] io-concurrency-cap (exit 1)
     - [  84ms] safe-regex/flags-normalization.test (exit 1)

  LOGS: ./tests/.logs/run-1769385568760-os4hbf