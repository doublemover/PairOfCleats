export const treeSitterState = {
  ...
  persistentChunkCacheRoot: null,
  persistentChunkCacheMemo: new Map(),
  persistentChunkCacheMisses: new Set(),
  nodeDensity: new Map(),
  ...
  metrics: {
    ...
    chunkCachePersistentHits: 0,
    chunkCachePersistentMisses: 0,
    chunkCachePersistentWrites: 0,
    chunkCachePersistentErrors: 0,
