...
/**
 * Build stage1 timing and queue-delay observers plus the final payload builder.
 *
 * @param {{
 *  runtime?:object|null,
 *  queueDelayHistogramBucketsMs?:number[],
 *  queueDelayTelemetryChannel?:string,
 *  stageFileWatchdogConfig?:object|null,
 *  extractedProseLowYieldBailout?:object|null
 * }} [input]
 * @returns {{
 ...
 * }}
 */
export const createStage1TimingBreakdownTracker = ({
  runtime = null,
  queueDelayHistogramBucketsMs = [],
  queueDelayTelemetryChannel = 'stage1.file-queue-delay',
  ...
  const queueDelayHistogram = createDurationHistogram(queueDelayHistogramBucketsMs);
