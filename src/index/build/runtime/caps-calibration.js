...
const ROUTE_BASELINES = Object.freeze({
  ...
  'tree-sitter-sql': Object.freeze({ maxBytes: 384 * 1024, maxLines: 6500, maxParseMs: 1800 }),
...
const LANGUAGE_BASELINE_OVERRIDES = Object.freeze({
  ...
  proto: Object.freeze({ maxBytes: 320 * 1024, maxLines: 5000, maxParseMs: 1500 }),
  graphql: Object.freeze({ maxBytes: 320 * 1024, maxLines: 5000, maxParseMs: 1500 }),
  sql: Object.freeze({ maxBytes: 384 * 1024, maxLines: 6500, maxParseMs: 1800 }),
