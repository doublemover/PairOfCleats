...
const ROUTE_BASELINES = Object.freeze({
  ...
  'tree-sitter-starlark': Object.freeze({ maxBytes: 256 * 1024, maxLines: 4000, maxParseMs: 1300 }),
  'tree-sitter-nix': Object.freeze({ maxBytes: 256 * 1024, maxLines: 4000, maxParseMs: 1300 }),
  'tree-sitter-dart': Object.freeze({ maxBytes: 320 * 1024, maxLines: 5000, maxParseMs: 1500 }),
  'tree-sitter-scala': Object.freeze({ maxBytes: 384 * 1024, maxLines: 6000, maxParseMs: 1700 }),
  'tree-sitter-groovy': Object.freeze({ maxBytes: 320 * 1024, maxLines: 5000, maxParseMs: 1500 }),
  'tree-sitter-r': Object.freeze({ maxBytes: 256 * 1024, maxLines: 4500, maxParseMs: 1400 }),
  'tree-sitter-julia': Object.freeze({ maxBytes: 320 * 1024, maxLines: 5000, maxParseMs: 1500 }),
  ...
  'line-parser-makefile': Object.freeze({ maxBytes: 256 * 1024, maxLines: 4500, maxParseMs: 1000 }),
