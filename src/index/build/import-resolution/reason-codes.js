...
export const IMPORT_REASON_CODES = Object.freeze({
  ...
  FILESYSTEM_PROBE_ERROR: 'IMP_U_FILESYSTEM_PROBE_ERROR',
  ...
  BAZEL_WORKSPACE_ROOT_SENTINEL: 'IMP_U_BAZEL_WORKSPACE_ROOT_SENTINEL',
  BAZEL_LABEL_PACKAGE_MISSING: 'IMP_U_BAZEL_LABEL_PACKAGE_MISSING',
  BAZEL_LABEL_TARGET_MISSING: 'IMP_U_BAZEL_LABEL_TARGET_MISSING',
  BAZEL_EXTERNAL_REPOSITORY_UNAVAILABLE: 'IMP_U_BAZEL_EXTERNAL_REPOSITORY_UNAVAILABLE',
  MAKEFILE_GENERATED_TARGET_MISSING: 'IMP_U_MAKEFILE_GENERATED_TARGET_MISSING',
  CONFIG_ROOT_SENTINEL: 'IMP_U_CONFIG_ROOT_SENTINEL',
  CONFIG_ROOT_ANCHORED_PATH: 'IMP_U_CONFIG_ROOT_ANCHORED_PATH',
  CONFIG_GLOB_PATTERN: 'IMP_U_CONFIG_GLOB_PATTERN',
...
export const IMPORT_REASON_DECISIONS = Object.freeze({
  ...
  [IMPORT_REASON_CODES.FILESYSTEM_PROBE_ERROR]: Object.freeze({
  ...
  [IMPORT_REASON_CODES.BAZEL_WORKSPACE_ROOT_SENTINEL]: Object.freeze({
    failureCause: IMPORT_FAILURE_CAUSES.RESOLVER_GAP,
    disposition: IMPORT_DISPOSITIONS.SUPPRESS_GATE,
    resolverStage: IMPORT_RESOLVER_STAGES.BUILD_SYSTEM_RESOLVER
  }),
  [IMPORT_REASON_CODES.BAZEL_LABEL_PACKAGE_MISSING]: Object.freeze({
    failureCause: IMPORT_FAILURE_CAUSES.MISSING_FILE,
    disposition: IMPORT_DISPOSITIONS.ACTIONABLE,
    resolverStage: IMPORT_RESOLVER_STAGES.BUILD_SYSTEM_RESOLVER
  }),
  [IMPORT_REASON_CODES.BAZEL_LABEL_TARGET_MISSING]: Object.freeze({
    failureCause: IMPORT_FAILURE_CAUSES.MISSING_FILE,
    disposition: IMPORT_DISPOSITIONS.ACTIONABLE,
    resolverStage: IMPORT_RESOLVER_STAGES.BUILD_SYSTEM_RESOLVER
  }),
  [IMPORT_REASON_CODES.BAZEL_EXTERNAL_REPOSITORY_UNAVAILABLE]: Object.freeze({
    failureCause: IMPORT_FAILURE_CAUSES.MISSING_DEPENDENCY,
    disposition: IMPORT_DISPOSITIONS.SUPPRESS_GATE,
    resolverStage: IMPORT_RESOLVER_STAGES.BUILD_SYSTEM_RESOLVER
  }),
  [IMPORT_REASON_CODES.MAKEFILE_GENERATED_TARGET_MISSING]: Object.freeze({
    failureCause: IMPORT_FAILURE_CAUSES.GENERATED_EXPECTED_MISSING,
    disposition: IMPORT_DISPOSITIONS.SUPPRESS_GATE,
    resolverStage: IMPORT_RESOLVER_STAGES.BUILD_SYSTEM_RESOLVER
  }),
  [IMPORT_REASON_CODES.CONFIG_ROOT_SENTINEL]: Object.freeze({
    failureCause: IMPORT_FAILURE_CAUSES.RESOLVER_GAP,
    disposition: IMPORT_DISPOSITIONS.SUPPRESS_GATE,
    resolverStage: IMPORT_RESOLVER_STAGES.CLASSIFY
  }),
  [IMPORT_REASON_CODES.CONFIG_ROOT_ANCHORED_PATH]: Object.freeze({
    failureCause: IMPORT_FAILURE_CAUSES.RESOLVER_GAP,
    disposition: IMPORT_DISPOSITIONS.SUPPRESS_GATE,
    resolverStage: IMPORT_RESOLVER_STAGES.CLASSIFY
  }),
  [IMPORT_REASON_CODES.CONFIG_GLOB_PATTERN]: Object.freeze({
    failureCause: IMPORT_FAILURE_CAUSES.RESOLVER_GAP,
    disposition: IMPORT_DISPOSITIONS.SUPPRESS_GATE,
    resolverStage: IMPORT_RESOLVER_STAGES.CLASSIFY
  }),
