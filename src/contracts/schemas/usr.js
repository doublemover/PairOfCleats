...
export const USR_REPORT_SCHEMA_DEFS = Object.freeze({
  ...
  'usr-gate-evaluation-summary': reportSchema('usr-gate-evaluation-summary'),
  ...
  'usr-registry-schema-validation': reportSchema('usr-registry-schema-validation'),
  'usr-registry-cross-invariant-validation': reportSchema('usr-registry-cross-invariant-validation'),
  'usr-evidence-freshness-report': reportSchema('usr-evidence-freshness-report'),
  'usr-feature-flag-policy-evaluation': reportSchema('usr-feature-flag-policy-evaluation'),
  'usr-lane-policy-evaluation': reportSchema('usr-lane-policy-evaluation'),
  'usr-backcompat-matrix-results': reportSchema('usr-backcompat-matrix-results'),
  'usr-drift-report': reportSchema('usr-drift-report'),
  'usr-contract-drift-report': reportSchema('usr-contract-drift-report'),
  'usr-change-management-log': reportSchema('usr-change-management-log'),
  'usr-governance-readiness-summary': reportSchema('usr-governance-readiness-summary'),
  'usr-contract-ownership-report': reportSchema('usr-contract-ownership-report'),
  'usr-rfc-change-impact-summary': reportSchema('usr-rfc-change-impact-summary'),
